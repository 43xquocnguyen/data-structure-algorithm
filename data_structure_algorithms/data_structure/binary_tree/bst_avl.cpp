...
{
    Node *rightChild = t->pRight;
    Node *leftRightChild = rightChild->pLeft;

    rightChild->pLeft = t;
    t->pRight = leftRightChild;

    return rightChild;
}
Tree RightRolation(Tree t)
{
    Node *leftChild = t->pLeft;
    Node *rightLeftChild = leftChild->pRight;

    leftChild->pRight = t;
    t->pLeft = rightLeftChild;
...
void Adjustment_Balance(Tree &t) {
...
int main()
{
    ...
    cout << "Left: " << t->pLeft->data << endl;
    cout << "Right: " << t->pRight->data << endl;
    return 0;
}
